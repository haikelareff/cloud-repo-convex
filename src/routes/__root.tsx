      ...
      <html className="dark" lang="en">
        ...
        <body>
          {canShowLoading && (
            <div
              className={cn(
                "pointer-events-none fixed top-0 left-0 z-30 h-[300px] w-full -translate-y-full opacity-0 backdrop-blur-md transition-all delay-0 duration-300 dark:h-[200px] dark:rounded-[100%] dark:bg-white/10!",
            ...
            >
              <div
                className={
                  "absolute top-1/2 left-1/2 z-50 -translate-x-1/2 translate-y-[30px] rounded-lg bg-white/80 p-2 shadow-lg dark:bg-gray-700"
                }
              >
